...
def test_config_data_can_be_updated_with_visible_api_key(tmp_path: Path):
    ...
    assert config_data == {
        ...
        "ingest_gate_enabled": False,
        "ingest_gate_pass_threshold": 75,
        "ingest_gate_hold_threshold": 60,
        "ingest_gate_hard_reject_enabled": True,
        "ingest_gate_log_all_decisions": True,
        "ingest_gate_allow_force_pass": True,
        "ingest_gate_allow_force_reject": True,
        "ocr_enabled": True,
